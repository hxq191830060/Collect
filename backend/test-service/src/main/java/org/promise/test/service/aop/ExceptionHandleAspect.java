package org.promise.test.service.aop;
...
public class ExceptionHandleAspect {
    ...
    @Pointcut("execution(public org.promise.common.result.rpc.RpcResult org.promise.test.service.api.impl.*.*(..))||" +
            "execution(public * org.promise.test.service.http.*.*(..))")
    public void fail(){
