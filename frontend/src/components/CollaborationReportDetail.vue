<template>
  <div class="feedback-report">
    ...
    <p class="feedback-sub-header mt-32">1. 协作基本信息</p>
    <div class="feedback-base-info ml-16">
      ...
      <p class="mt-16">
        <span class="info-key">1.2 协作方：</span>
        <span class="info-value">{{ feedbackReportInfo.nickname }}</span>
      </p>
      <div class="mt-16">
        <span class="info-key">1.3 缺陷统计：</span>
...
<script>
export default {
  name: "CollaborationReportDetail",
};
</script>
<script setup>
